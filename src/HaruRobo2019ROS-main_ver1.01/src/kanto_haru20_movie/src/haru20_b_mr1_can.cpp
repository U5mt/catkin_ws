...
private:
    ...
    static constexpr uint16_t id_ft_0_motor_cmd         = 0x600;
...
Mr1CanNode::Mr1CanNode(void)
{
    ...
    _ft_1_motor_cmd_pos_sub	    	    =ase/m _nh.subscribe<std_msgs::Float32>("botor1_cmd_vel", 10, &Mr1CanNode::ft1motorCmdPosCallback, this);
